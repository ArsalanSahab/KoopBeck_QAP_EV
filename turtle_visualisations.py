...
# TURTLE CLAASS TO DRAW VISUALISATION (CODE FOR THIS CLASS HAS BEEN TAKEN FROM INTERNET AND EDITED )
# SOURCE : https://opentechschool.github.io/python-beginners/en/simple_drawing.html
class CustomDrawer(turtle.Turtle):

    # SETTINGS HAVE BEEN TAKEN FROM THE INTERNET AND EDITED
    POINT_RADIUS = 20
    ...
    # FUNCTION TO MAKE TURTLE MOVE TO CENTER
    ...
    # FUNCTION TO DRAW POINTS WITH THE TURTLE
